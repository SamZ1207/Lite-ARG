...
let div1 = document.getElementById('thingie').getBoundingClientRect();
let div1Top = div1.top;
let div1Left = div1.left;
let div1Right = div1.right
let div1Bottom = div1.bottom

let div2 = document.getElementById('home').getBoundingClientRect();
let div2Top = div2.top;
let div2Left = div2.left;
let div2Right = div2.right
let div2Bottom = div2.bottom

if (div1.x < div2.x + div2.width &&
   div1.x + div1.width > div2.x &&
   div1.y < div2.y + div2.height &&
   div1.height + div1.y > div2.y) {
	// Collision detected!
   console.log('test');
}